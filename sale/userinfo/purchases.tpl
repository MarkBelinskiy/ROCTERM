[if-items]
<div class="sale-user-order[accepted] accepted[/accepted][sold] sold[/sold][shipped] shipped[/shipped][closed] closed[/closed]">
	<div class="row">
		...
		<div class="col-sm-3 col-xs-6 text-right sale-user-status">
			...
			[sold]<span class="tt" title="Статус заказа"><i class="fa fa-battery-quarter fa-lg" aria-hidden="true"></i> Оплачен</span>[/sold]
			[shipped]<span class="tt" title="Статус заказа"><i class="fa fa-battery-three-quarters fa-lg" aria-hidden="true"></i> Отгружен</span>[/shipped]
			[closed]<span class="tt" title="Статус заказа"><i class="fa fa-battery-full fa-lg" aria-hidden="true"></i> Проведен</span>[/closed]
		</div>
	</div>
	<div class="row">
		{items}
	...
	<div class="row">
		...
		<div class="col-sm-12 sale-user-info sale-user-xfcomm">
			...
			[shipment]<div class="shipped"><b>Информация об отгрузке:</b><br>{shipment}</div>[/shipment]
		</div>
	</div>
</div>
[/if-items]
